...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "RegistroCombustibles.dll" comes first in this list. */
		"RegistroCombustibles.dll",
		"Lottie.Android.dll",
		"MaterialSpinner.dll",
		...
		"RegistroCombustibles.Common.Models.dll",
		"RegistroCombustibles.Common.SoapServices.dll",
		"RegistroCombustibles.Common.Utils.dll",
